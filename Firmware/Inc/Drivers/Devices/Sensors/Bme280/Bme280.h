...
namespace Driver {
    ...
    enum Bme280Filter {
        ...
        BME280_FILTER_2   = 0x40,
        BME280_FILTER_4   = 0x80,
        BME280_FILTER_8   = 0xC0,
    ...
    class Bme280 : public Device<I2c> {
        private:
            uint8_t m_buffer[BME280_BUFFER_SIZE]; // receiving buffer
            uint8_t m_bufferSize;                 // size of buffer
            int32_t m_pressureCode;
            int32_t m_temperCode;
            int32_t m_humidityCode;
            int32_t m_tCompensCode;
